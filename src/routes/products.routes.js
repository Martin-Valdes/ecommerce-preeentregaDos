...
router.post("/", passportCall("jwt"), authorization("admin"), verifyDataProduct, productsControllers.createproduct);

////ELIMINAMOS UN PRODUCTO MEDIANTE ID
router.delete("/:pid", passportCall("jwt"), verifyProductExist,authorization("admin"), productsControllers.deleteProduct);
